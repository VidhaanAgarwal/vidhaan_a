...
level 22 - 0Zf11ioIjMVN551jX3CmStKLYqjk54Ga - cat cronjob_bandit23, then cat /usr/bin/cronjob_bandit23.sh. Reading shell file and figuring out file location using echo I am user bandit23 | md5sum | cut -d ' ' -f 1, then cat 
